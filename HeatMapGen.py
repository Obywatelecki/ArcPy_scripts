...
mxd = arcpy.mapping.MapDocument("D:/GD/WGiSR/_Konferencje/Plener 2018/heatMap/HeatMap_knajpy.mxd")
df = arcpy.mapping.ListDataFrames(mxd)[0]
print "         Local variables set! " + str(time.ctime())

def heatMapGen(radius, cellSize, template, inData):
    ...
    arcpy.mapping.ExportToJPEG(mxd, "D:/GD/WGiSR/_Konferencje/Plener 2018/heatMap/_genMaps/HeatMap_radius_" + str(radius) + ".jpg")
